...
acf_add_local_field_group([
    ...
    'fields' => [
        ...
        [
            'key' => 'field_hitta_direkt_columns',
            'label' => __('Kolumner', 'modularity-hitta-direkt'),
            'name' => 'columns',
            'type' => 'select',
            'required' => 1,
            'choices' => [
                '1' => __('1 kolumn', 'modularity-hitta-direkt'),
                '2' => __('2 kolumner', 'modularity-hitta-direkt'),
                '3' => __('3 kolumner', 'modularity-hitta-direkt'),
                '4' => __('4 kolumner', 'modularity-hitta-direkt'),
                '5' => __('5 kolumner', 'modularity-hitta-direkt'),
            ],
            'default_value' => '5',
            'return_format' => 'value',
            'allow_null' => 0,
